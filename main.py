...
student_one.rate_lecrurer(lecturer_one, 'Python', 8)
student_one.rate_lecrurer(lecturer_one, 'Python', 8)
student_one.rate_lecrurer(lecturer_one, 'Python', 8)
...
reviewer_two.rate_hw(student_two, 'Git', 6)
reviewer_two.rate_hw(student_two, 'Git', 6)
reviewer_two.rate_hw(student_two, 'Git', 6)
...
student_list = [student_two, student_one]


def calculating_the_average_course_score_st(course, students):
    count = 0
    y = 0
    grade_of_course_student = 0
    for student in student_list:
        grade_of_course_list = []
        grade_of_course_list += student.grades[course]
        for grade_averange in grade_of_course_list:
            grade_of_course_student += grade_averange
            count += 1
            x = grade_of_course_student / count
    y += x
    return y
...
def calculating_the_average_course_score_lc(course, lecturers):
    count = 0
    y = 0
    grade_of_course_lecturer = 0
    for lecturer in lecturer_list:
        grade_of_course_list = []
        grade_of_course_list += lecturer.grades[course]
        for grade_averange in grade_of_course_list:
            grade_of_course_lecturer += grade_averange
            count += 1
            x = grade_of_course_lecturer / count
    y += x
    return y
...
print('')
print(calculating_the_average_course_score_st('Python', student_list))
print('')
print(calculating_the_average_course_score_lc('Python', lecturer_list))
